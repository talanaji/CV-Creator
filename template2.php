                ...
                <div id="rb-content-top">
                    <div id="rb-top-info-img">
                        <div id="rb-box-ava" class="YourImage">
                            <img id="cv-ava" ng-src="{{PreviewImage}}" ng-show="PreviewImage != null" alt=""
                    ...
                    <div id="rb-top-info-contact">
                        <div class="top-contact">
                            <p class="icoweb" id="EmailLabel"><i
                                    class="fa fa-envelope-square"></i><span>{{email}}</span>
                        </div>
                        <div class="top-contact">
                            <p class="icoweb" id="PhoneNumberLabel"><i class="fa fa-phone"></i><span>{{phone}}</span>
                            </p>
                        ...
                        <div class="top-contact" id="FacebookUsernameLabel">
                            <p class="icoweb"><i class="fa fa-info"></i><span>fb.com/{{fb}}</span></p>
